...
app.post('/webhook', function (req, res) {  
    ...
    for (i = 0; i < events.length; i++) {
        ...
        if(event.message && event.message.text === "Help"){
            ...
            sendMessage(event.sender.id, {text: "Take the stairs in front of you (Go up 3 flights). Turn right and walk along this corridor. At the end of the corridor go up 2 flights of stairs. Turn right and right again. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right. It's the second door on your right."});            
        }
            ...
            sendMessage(event.sender.id, {text: "Take the stairs in front of you. Go up 3 flights. Turn right and walk along the corridor. At the end of the corridor take the stairs and go up 2 flights. Turn right and right again. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right and take the 3rd right. Turn left. The door is the first door on your left."});
        }
            ...
            sendMessage(event.sender.id, {text: "As you exit the library take the stairs to your left up 1 flight. Turn right and walk along the corridor. At the end of the corridor go up 2 flights. Turn right and right again. Walk along this corridor. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 5 flights of stairs. Walk along the corridor to your right. Take the second right. The door is just on your right."});
        }
           ...
           libraryC204(event.sender.id, {text: "Here"}); 
            ...
            sendMessage(event.sender.id, {text: "As you exit the library take the stairs to your left and go up 1 flight. Turn right and walk along the corridor. At the end of the corridor go up 2 flights of stairs. Turn right and right again. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right and take the third right. Turn left. S2.21 is the first door on your left."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn right as you leave the room and then right again. Turn left and walk along the corridor. Go up 2 flights of stairs. Turn right and go down 1 flight of stairs. Turn right, then left, and walk along the corridor. At the end of the corridor turn left. Take the stairs on your left and go down 2 flights. Take the corridor straight ahead. At the end of the corridor go up 1 flight of stairs. Go through the door in front of you. Walk along the corridor. T2.07 is the second door on your right."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn right and right again as you leave the room. Turn left and walk along the corridor. Go up 2 flights of stairs. Turn right and go down 1 flight of stairs. Turn right, then left, and walk along the corridor. At the end of the corridor turn left. Take the stairs on your left and go down 2 flights. Take the corridor straight ahead. At the end of the corridor go up 1 flight of stairs. T2.09 is just to your right."}); 
        }
        else if (event.message && event.message.text === "I am at S2.21 and I want to go to N4.07") { 
            sendMessage(event.sender.id, {text: "Turn right and right again as you leave the room. Turn left and walk along the corridor. Go up 2 flights of stairs. Turn right and go down 1 flight of stairs. Turn right, then left, and walk along the corridor. At the end of the corridor turn left. Take the stairs on your left and go up 4 flights. Turn left at the top of the stairs. N4.07 is at the top of the stairs."}); 
        } 
            ...
            sendMessage(event.sender.id, {text: "Turn left as you leave the room and walk along the corridor. Go up 2 flights of stairs. Turn right and go down 1 flight of stairs. Turn right, then left and walk along the corridor. At the end of the corridor turn left. Take the stairs on your left and go down 2 flights. Take the corridor straight ahead. At the end of the corridor go down 3 flights of stairs. The canteen is to your right."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn left as you leave the room and walk along the corridor. Go up 2 flights of stairs. Turn right and go down 1 flight of stairs. Turn right, then left and walk along the corridor. At the end of the corridor turn left. Take the stairs on your left and go up 4 flights. Turn left at the top of the stairs. The door is at the top of the stairs. "}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn left as you leave the room. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right and take the third right. Turn left. S2.21 is the first door on your left."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Go down 1 flight of stairs and turn right. Go down 4 flights of stairs. Turn right and right again. Walk along this corridor. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right. S2.22 is the second door on your right."}); 
        } 
        else if (event.message && event.message.text === "I am at N4.07 and I want to go to S2.21") { 
            sendMessage(event.sender.id, {text: "Go down 1 flight of stairs and turn right. Go down 4 flights of stairs. Turn right and right again. Walk along this corridor. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right and take the third right. Turn left. S2.21 is the first door on your left."}); 
        }
        else if (event.message && event.message.text === "I am at N4.07 and I want to go to S1.32") { 
            sendMessage(event.sender.id, {text: "Go down 1 flight of stairs and turn right. Go down 4 flights of stairs. Turn right and right again. Walk along this corridor. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 5 flights of stairs. Walk along the corridor to your right and take the second right. S1.32 is just on your right."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn left as you leave T2.09 and take the stairs. Go down 1 flight of stairs. Walk along this corridor. At the end of the corridor go up 2 flights of stairs. Turn right and right again. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 2 flights of stairs. Walk along the corridor to your right. S2.22 is the second door on your right."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn left as you leave T2.09 and take the stairs. Go down 1 flight of stairs. Walk along this corridor. At the end of the corridor go up 2 flights of stairs. Turn right and right again. At the end of the corridor turn right. Turn left and go up 1 flight of stairs. Turn left and go down 5 flights of stairs. Walk along the corridor to your right and take the second right. S1.32 is just on your right."}); 
        }
            ...
            sendMessage(event.sender.id, {text: "Turn left as you leave S1.32, and turn left again. Walk along the corridor. At the end of the corridor take the stairs. Go up 5 flights. Turn right and go down 1 flight of stairs. Turn right, then left, and walk along the corridor. At the end of the corridor turn left. Take the stairs on your left and go down 2 flights. Take the corridor straight ahead. At the end of the corridor go down 3 flights of stairs. The canteen is to your right."}); 
        }

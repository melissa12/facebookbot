...
app.post('/webhook', function (req, res) {  
    ...
    for (i = 0; i < events.length; i++) {
        ...
        if (event.message && event.message.text === "I am at T2.09 and I want to go to C2.07"){
            ...
            sendMessage(event.sender.id, {text: "Take the stairs that are in front of you (Go up 3 flights). Turn right and walk along the corridor. At the end of the corridor go up 2 flights of stairs. Turn right and right again. Walk along the corridor. It's the fourth door on your left."});
        }
        else if (event.message && event.message.text === "I am at the canteen and I want to go to C2.07") {
            sendMessage(event.sender.id, {text: "Take the stairs in front of you (Go up 3 flights). Turn right and walk along the corridor. At the end of the corridor go up 2 flights of stairs. Turn right and right again. Walk along this corridor. It's the seventh door on your left."});
        }
